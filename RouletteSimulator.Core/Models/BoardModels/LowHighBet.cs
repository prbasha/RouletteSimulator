    ...
    public class LowHighBet : Bet
    {
        ...
        public override int CalculateWinnings(int winningNumber)
        {
            try
            {
                ...
                {
                    case BetType.Low:
                        winnings = Constants.LowWinningNumbers.Contains(winningNumber) ? CalculateWinnings() : CalculateLosses();
                        break;
                    case BetType.High:
                        winnings = Constants.HighWinningNumbers.Contains(winningNumber) ? CalculateWinnings() : CalculateLosses();
                        break;
                }
